...
export default {
	...
	data() {
		return {
			...
			residencybtns: [],
			maritalbtns: ["Married", "Single", "Widow"],
			educationbtns: [
				"Primary School",
				"Secondary School",
				"College",
			...
			suicidebtns: ["Idea", "Plan", "Attempt"],
			familybtns: ["Present", "Absent"],
			pphbtns: ["Positive", "Negative"],
			pmshbtns: ["Positive", "Negative"],
			drugsbtns: ["Positive", "Negative"],
			specialistbtns: [],
			alcoholbtns: ["Positive", "Negative"],
			substancebtns: ["Positive", "Negative"],
			substancebtns: [],
			appearancebtns: [],
			speechbtns: [],
			moodbtns: [],
