...
export default {
  ...
  computed: {
    occupation() {
      ...
      return tt.map((el) => {
        return `(${el.user} @ ${new Date(el.date).toLocaleDateString(
          "en-GB"
        )}) : ${el.comment} \n`;
      });
    },
  ...
  mounted() {
    this.localBtnDB
      .get("allbtns")
      .then((res) => {
        this.genderbtns = res.genderbtns;
        this.residencybtns = res.residencybtns;
        this.maritalbtns = res.maritalbtns;
        this.educationbtns = res.educationbtns;
        this.suicidebtns = res.suicidebtns;
        this.residencybtns = res.residencybtns;
        this.familybtns = res.familybtns;
        this.pphbtns = res.pphbtns;
        this.pmshbtns = res.pmshbtns;
        this.drugsbtns = res.drugsbtns;
        this.specialistbtns = res.specialistbtns;
        this.alcoholbtns = res.alcoholbtns;
        this.substancebtns = res.substancebtns;
        this.appearancebtns = res.appearancebtns;
        this.speechbtns = res.speechbtns;
        this.moodbtns = res.moodbtns;
        this.cognitivebtns = res.cognitivebtns;
        this.perceptionbtns = res.perceptionbtns;
        this.thoughtbtns = res.thoughtbtns;
      })
